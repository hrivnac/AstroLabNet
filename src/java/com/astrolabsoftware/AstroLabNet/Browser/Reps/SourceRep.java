...
import com.astrolabsoftware.AstroLabNet.Browser.Reps.EventHandlers.SourceEventHandler;
...
public class SourceRep extends ElementRep {
  ...
  public void addTab() {
    // Desc
    Label desc = new HeaderLabel(toString(), "Source...");
    // Cmd
    ...
    button.setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent e) {
        String result = serverRep().hbase().scanEncoded("astrolabnet.catalog.1", null, 0, 0, 0); // TBD: via params
